...
export type FilterExpression = (globalProperties: GlobalProperties, feature: Feature, canonical?: CanonicalTileID) => boolean;
...
export declare class HandlerManager {
	...
	handleEvent(e: Event, eventName?: string): void;
...
export declare class TwoFingersTouchHandler {
	_enabled: boolean;
	_active: boolean;
	_firstTwoTouches: [
		number,
